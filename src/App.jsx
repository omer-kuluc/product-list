  ...
  return(
    <div className="dessertItem">
      ...
      }>
      {
        ...
        (
          <>
            <img onClick={onDessertClick} src="/img/cart.svg" alt="" />
            <span onClick={onDessertClick}>Add to Cart</span>
          </>
        )
      }  
      </div>
...
function Basket({cartList, totalPrice, deleteDessert, onOpenModal}) {
  return (
    <div className="cart-list-container">
      <h3 className='cart-header'>Your Cart({cartList.length})</h3>
